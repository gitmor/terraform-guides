...
resource "aws_lambda_function" "getUntaggedInstances" {
  ...
  source_code_hash = "${base64sha256(filebase64sha256("./files/getUntaggedInstances.zip"))}"
  runtime          = "python3.6"
  timeout          = "120"
...
resource "aws_lambda_function" "getTaggedInstances" {
  ...
  source_code_hash = "${base64sha256(filebase64sha256("./files/getTaggedInstances.zip"))}"
  runtime          = "python3.6"
  timeout          = "120"
...
resource "aws_lambda_function" "getRunningInstances" {
  ...
  source_code_hash = "${base64sha256(filebase64sha256("./files/getRunningInstances.zip"))}"
  runtime          = "python3.6"
  timeout          = "120"
